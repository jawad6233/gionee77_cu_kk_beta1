...
// LuckAs change from GN
//gionee chenqiang add for  wifi sdio chose 1.8v  CR00678982 begin
#ifdef GN_MTK_BSP_WIFI_SOID_V_18
...
//gionee suxt 20120807 modify for WIFI open faild begin
	  //.flags          = MSDC_TABDRV | MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED,//| MSDC_HIGHSPEED
// Luckas change!!!! worked 1_rev
//	    .flags          = MSDC_TABDRV | MSDC_INTERNAL_CLK | MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED,//| MSDC_HIGHSPEED
// LuckAs try!!!
	    .flags          = MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED,//| MSDC_HIGHSPEED
//gionee suxt 20120807 modify for WIFI open faild end
// LuckAs add for define SOID_V_18
		.dat0rddly		= 0,
		.dat1rddly		= 0,
		.dat2rddly		= 0,
		.dat3rddly		= 0,
...
#endif
//gionee chenqiang add for  wifi sdio chose 1.8v CR00678982 end
// LuckAs end
    #else
    struct msdc_hw msdc3_hw = {
	    .clk_src        = 1,
